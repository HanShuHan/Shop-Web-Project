										...
										<table class="table table-striped table-sm" id="table_id">
											...
											<tbody>
												<c:forEach var="OrderBean" items="${OrderBeans}">
													<tr>
														<td><a href="${contextRoot}/oneOR?id=${OrderBean.merchantTradeNo}">${OrderBean.merchantTradeNo}</a></td>
		                           						<td><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss" value="${OrderBean.merchantTradeDate}"></fmt:formatDate></td>
