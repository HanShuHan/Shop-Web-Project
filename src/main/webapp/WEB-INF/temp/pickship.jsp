		...
		<div class="container">
			<div class="col-md-12">
				<div class="invoice">
					...
					<div class="invoice-company text-inverse f-w-600">門市確認</div>
					<!-- end invoice-company -->
					...
					<div class="invoice-header">
						...
						<div class="invoice-to">
							<small>請選擇店到店門市</small>
							<address class="m-t-5 m-b-5">
								<strong class="text-inverse">請選擇</strong><br>
								<form method="post" action="${contextRoot}/pickship">
									<input id="ddd" name="ddd" type="hidden" value="FAMI">
									<input width="100" height="100" type="image" name="image"
										src="${contextRoot}/images/FM.png" onclick="submit()">
								</form>
								<form method="post" action="${contextRoot}/pickship">
									<input id="ddd" name="ddd" type="hidden" value="UNIMART">
									<input width="100" height="100" type="image" name="image"
										src="${contextRoot}/images/711.png" onclick="submit()">
								</form>
							</address>
						</div>
					...
					<h5 style="text-align: center;">請選擇上方圖示</h5>
