			...
			<div class="container-fluid px-lg-5">
				...
				<nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						<li class="active"><a href="${contextRoot}/shop">Products</a>
							<ul>
			...
			<div class="row">
				...
				<div class="side-bar col-lg-4">
					...
					<div class="search-bar w3layouts-newsletter">
						...
						<form method="get" class="d-flex">
							<input type="search" name="nameLike" value="${nameLike}"
								...
								autocomplete="on">
							<button id="search-products-btt" type="button"
								class="btn btn-success">Search</button>
							<a class="btn btn-primary" href="${contextRoot}/shop">Reset</a>
						</form>
					</div>
					<!--類別-->
					...
					<div class="left-side">
						...
						<label for="price-order-checkbox" class="span">價格</label> <select
							id="price-order">
							<c:choose>
					...
					<div class="left-side">
						...
						<input type="number" id="price_lower_bound" class="price-input"
							value="${priceLowerBound}"> - <input type="number"
							id="price_upper_bound" class="price-input"
							value="${priceUpperBound}"> &nbsp;&nbsp;&nbsp;&nbsp;<span
						...
						<c:forEach var="adproduct" items="${adproducts}">
							<div class="special-sec1 row mb-3">
								<div class="img-deals col-md-4">
									<a
										href='<c:url value="/customerProduct/${adproduct.productId}"/>'>
										<img src='<c:url value="/showImage1/${adproduct.productId}"/>'
										class="img-fluid" alt="">
									</a>
								</div>
								<div class="img-deal1 col-md-4">
									...
									</a><br> <span class="money"> NT$<c:out
									...
									<c:choose>
										<c:when test="${sessionScope.accountId == null}">
											...
											<a class="go-to-cart"
												href="${contextRoot}/register?goToCart=true&productID=${adproduct.productId}"><span>直接購買</span></a>
										</c:when>
										<c:otherwise>
							...
							<div class="col-md-4 product-men">
								<div class="product-shoe-info shoe text-center">
									<div class="men-thumb-item">
										<a
											href='<c:url value="/customerProduct/${product.productId}"/>'><img
								...
								<c:forEach begin="3" end="15" step="3" var="pageNum">
									<c:choose>
										<c:when test="${eachPageNum == pageNum}">
											<option value="${pageNum}" selected><c:out
													value="${pageNum}" /></option>
										</c:when>
										<c:otherwise>
