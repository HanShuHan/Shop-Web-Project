							...
							<div class="card">
								<div class="card-body">
								 <a class="btn btn-sm btn-primary" href="${contextRoot}/badindex">返回</a>
									<a class="btn btn-sm btn-primary" href="${contextRoot}/updateAdminBean?id=${AdminBean.id}">更新</a>
										<br><br>
										...
										<div class="form-group">
											...
											<label>註冊時間：</label>
											<p><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss" value="${AdminBean.added}"></fmt:formatDate><br><br>
											<label>修改時間：</label>
											<p><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss" value="${AdminBean.updated}"></fmt:formatDate><br><br>
										</div>
								</div>
							</div>
						</div>
