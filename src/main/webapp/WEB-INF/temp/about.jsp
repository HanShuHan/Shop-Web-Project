		...
		<div class="container">
			<div class="inner-sec py-md-5 px-lg-5">
				<h3 class="tittle text-center">
					<span class="sub-tittle">About.</span>歡迎來到我們的商店
				</h3>
		...
		<div class="container py-md-3">
			<div class="row banner-grids">
				<div class="col-md-6 banner-image">
					<div class="effect-w3">
						<img src="images/sport1.jpg" alt="" class="img-fluid image1">
				...
				<div class="col-md-6 last-img pl-lg-5 p-3">
					...
					<h3 class="tittle mb-lg-5 mb-3">
						<span class="sub-tittle">阿珍體育用品創辦人</span>
					MajorSubject-HO 曾說：</h3>
					-->
						...
						<div class="container">
							<div class="row footer-top">
								<div class="col-lg-4 footer-grid_section_w3layouts">
									<p class="col-md-10">
										© 2022 A-Jen Sport. All rights reserved | Design by 
										<a href="https://www.ispan.com.tw/longterm/JJEEITT"
											target="_blank"
										>資展國際 EEIT138.</a>
									</p>
								</div>
