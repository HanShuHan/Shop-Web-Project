		   ...
		   <div class="col-md-12">
		      <div class="invoice">
		         ...
		         <div class="invoice-header">
		            <div class="invoice-from">
		             ...
		             <div class="invoice-to">
		               <small>取貨門市</small>
		               <address class="m-t-5 m-b-5">
		                  <strong class="text-inverse"></strong><c:if test='${OrderBean.logisticsSubType == "UNIMART"}'>7-11</c:if><br>
		                  ${OrderBean.cVSStoreName}<br>
		                  地址：${OrderBean.cVSAddress}<br>
		                  門市號：${OrderBean.cVSStoreID}<br>
		               </address>
		            </div>
		            ...
		            <div class="table-responsive">
		               <table class="table table-invoice">
		                  <thead>
		                     <tr>
		                        <th>付款資訊</th>
		                        <th class="text-center" width="10%">總價</th>
		                        <th class="text-center" width="10%">付款方式</th>
		                        <th class="text-right" width="20%">付款狀態</th>
		                     </tr>
		                  </thead>
		                  <tbody>
		                     <tr>
		                        <td>
		                           <small>${OrderBean.merchantTradeDate}</small>
		                        </td>
		                        <td class="text-center">${OrderBean.totalAmount}</td>
		                        <td class="text-center">${OrderBean.paymentType}</td>
		                        <td class="text-right">${OrderBean.tradeDesc}</td>
		                     </tr>
		                  </tbody>
		               </table>
		            </div>
		         ...
		         <!-- begin invoice-price -->
		            <div class="invoice-price">
		               ...
		               <div class="invoice-price-right">
		                  <small>總金額</small> <span class="f-w-600">NTD$${OrderBean.totalAmount}</span>
		               </div>
		            </div>
		            <!-- end invoice-price -->
		         </div>
		         ...
		         <div class="invoice-footer">
		            ...
		            <form action="${contextRoot}/tradenow" method="post">
		            <input id="merchantTradeNo" name="merchantTradeNo" type="hidden" value="${OrderBean.merchantTradeNo}">
		            <button class="btn btn-sm btn-white m-b-10 p-l-5" type="submit">確認出貨</button>
		            </form>
		         </div>
		         <!-- end invoice-footer -->
		      </div>
