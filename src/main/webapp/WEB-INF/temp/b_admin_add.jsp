							...
							<div class="card">
								<div class="card-body">
									...
									<form:form action="${contextRoot}/addAdminBean" modelAttribute="AdminBean"
										method="post" enctype="multipart/form-data" onsubmit="return validate()"><hr>
										<div id="big-image-container">
											<img src="" alt="" id="big-image">
										</div>
										<label for="image">管理員相片</label>
										<form:input type="file" name="image" id="image" path="Image" required="required" accept="image/*"/>
										<br><br>
										<label>帳號</label>
										...
										<a href="${contextRoot}/badindex"><button type="button" class="btn btn-primary">取消</button></a>
									</form:form>
								</div>
							</div>
						</div>
