		...
		<div class="container">
			<div class="col-md-12">
				<div class="invoice">
					...
					<div class="invoice-company text-inverse f-w-600">結帳確認</div>
					<!-- end invoice-company -->
					...
					<div class="invoice-header">
						...
						<div class="invoice-to">
							...
							<address class="m-t-5 m-b-5">
								...
								<c:if test='${OrderBean.logisticsSubType == "UNIMART"}'>7-11</c:if>
								<br> ${OrderBean.cVSStoreName}<br>
								地址：${OrderBean.cVSAddress}<br> 門市號：${OrderBean.cVSStoreID}<br>
							</address>
						</div>
						<div class="invoice-date">
							<small>訂單編號</small>
							<div class="date text-inverse m-t-5">${OrderBean.merchantTradeNo}</div>
						</div>
					</div>
					<!-- end invoice-header -->
					...
					<div class="invoice-footer">
						...
						<form action="${contextRoot}/checkout" method="post">
							<input id="merchantTradeNo" name="merchantTradeNo" type="hidden"
								value="${OrderBean.merchantTradeNo}">
							<button class="btn btn-sm btn-white m-b-10 p-l-5" type="submit">前往繳費</button>
						</form>
					</div>
					<!-- end invoice-footer -->
				</div>
