										...
										<table class="table table-striped table-sm" id="table_id">
											...
											<tbody>
												<c:forEach var="account" items="${accounts}">
													<tr>
														<td><a href="${contextRoot}/oneAC?id=${account.acid}"><c:out value="${account.ac}"></c:out></a></td>
														<td><c:out value="${account.aname}"></c:out></td>
														<td><fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss" value="${account.added}"></fmt:formatDate></td>
														<td><div>
