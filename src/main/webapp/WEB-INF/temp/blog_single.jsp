                        	...
                        	<c:choose>
                        		...
                        		<c:otherwise>
                        			<a href="<c:url value='/myCartList/accountId/${sessionScope.accountId}'/>">
										<img id="cart-img" src="${contextRoot}/css/images/cart4.svg" data-user_id="${sessionScope.accountId}">
									</a>
                        ...
                        <div class="thumbnail card">
                            <div class="caption card-body">
                                ...
                                <p class="group inner list-group-item-text">
                                   <fmt:formatDate pattern="yyyy/MM/dd HH:mm:ss" value="${post.updated}"></fmt:formatDate></p><br>
                                   ${post.postcontent}
                                <div class="row">
